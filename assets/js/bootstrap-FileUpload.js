...
;(function ($, document, window, undefined) {
			...
			for (var i = 0; i < length; i++) {
				...
				if (instance[el].options.showThumb === true) {
					...
					if (instance[el].options.multiUpload === false) {
						row = '<tr class="fileupload-previewrow thumb row" id="' + fileName + '"><td class="col-lg-1">' + thumb + '</td><td class="col-lg-4">' + file.name + '</td><td class="col-lg-1">' + sizeDisplay + '</td><td class="col-lg-4">' + progressBar + '</td><td class="col-lg-2"><button class="btn btn-danger fileupload-remove" value="' + fileName + '"><i class="fa fa-ban"></i>&nbsp;<span>Cancel</span></button></td></tr>';
					} else {
	...
	function formStructure (el) {
		...
		instance[el].btnAdd = $('<div class="btn btn-success fileupload-add"><input type="file" ' + (instance[el].options.multiFile === true ? 'multiple="multiple"' : void 0) + 'multiple /><i class="fa fa-plus"></i>&nbsp;Add Files&hellip;</div>');
		...
		instance[el].btnStart = $('<button class="btn btn-warning fileupload-start"><i class="fa fa-file-upload"></i>&nbsp;<span>Start upload</span></button>');
		instance[el].btnCancel = $('<button type="reset" class="btn btn-danger fileupload-cancel"><i class="fa fa-ban"></i>&nbsp;<span>Cancel upload</span></button>');
